...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/cloud-market/elastic-ha-architecture-to-the-cloud.yml&hideStepRow=true&hideStackConfig=true&pageTitle=General Product Cloud Deployment Architecture (High Availability, Elasticity)&isSimplified=true&balanceIntercept=true) to enter the deployment page.
