## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/examples/csapps/existing-vpc-docker-cluster-harbor.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Harbor集群版(已有VPC)&isSimplified=true&balanceIntercept=true)进入部署页面。
