...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/help/ecs/tf-chat-glm2-6b.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Use c8i instances based on Intel CPU to deploy ChatGLM2-6B&isSimplified=true&balanceIntercept=true) to enter the deployment page.
