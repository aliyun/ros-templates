...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/examples/csapps/existing-vpc-docker-cluster-rancher.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Rancher集群版(已有VPC)&isSimplified=true&balanceIntercept=true) to enter the deployment page.
