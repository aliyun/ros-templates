## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/cloud-market/deploy-high-availability-architecture-to-the-cloud.yml&hideStepRow=true&hideStackConfig=true&pageTitle=通用产品上云部署架构(高可用)&isSimplified=true&balanceIntercept=true)进入部署页面。
