...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/solution/ai/use-function-compute-to-deploy-stable-diffusion-for-ai-painting.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Based on Function Computing to Deploy Stable Diffusion for AI Painting&isSimplified=true&balanceIntercept=true) to enter the deployment page.
