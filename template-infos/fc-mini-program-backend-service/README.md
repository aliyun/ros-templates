## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/mini-program/fc-mini-program-backend-service.yml&hideStepRow=true&hideStackConfig=true&pageTitle=函数计算搭建小程序Web应用后端服务&isSimplified=true&balanceIntercept=true)进入部署页面。
