...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/container-micro-service/spring-cloud-hostingack-service.yml&hideStepRow=true&hideStackConfig=true&pageTitle=SpringCloud application hosted on ACK service&isSimplified=true&balanceIntercept=true) to enter the deployment page.
