...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/help/ecs/aiacc.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Based on AIACC Accelerator to Quickly Realize AIGC Painting&isSimplified=true&balanceIntercept=true) to enter the deployment page.
