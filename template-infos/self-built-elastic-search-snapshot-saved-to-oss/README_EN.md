...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/backup-recovery/self-built-elastic-search-snapshot-saved-to-oss.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Self-builtElasticSearchSnapshotBackupOSS&isSimplified=true&balanceIntercept=true) to enter the deployment page.
