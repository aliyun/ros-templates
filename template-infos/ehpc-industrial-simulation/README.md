## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/high-performance-computing/ehpc-industrial-simulation.yml&hideStepRow=true&hideStackConfig=true&pageTitle=EHPC工业仿真&isSimplified=true&balanceIntercept=true)进入部署页面。
