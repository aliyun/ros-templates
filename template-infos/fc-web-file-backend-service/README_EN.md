...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/serviceless-compute/fc-web-file-backend-service.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Based on Function Compute to Build Website File Processing&isSimplified=true&balanceIntercept=true) to enter the deployment page.
