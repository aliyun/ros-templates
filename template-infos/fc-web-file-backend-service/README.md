## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/serviceless-compute/fc-web-file-backend-service.yml&hideStepRow=true&hideStackConfig=true&pageTitle=基于函数计算搭建网站文件处理&isSimplified=true&balanceIntercept=true)进入部署页面。
