...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/help/oss/centOS-ecs-oss.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Based on CentOS ECS instance to implement OSS reverse proxy&isSimplified=true&balanceIntercept=true) to enter the deployment page.
