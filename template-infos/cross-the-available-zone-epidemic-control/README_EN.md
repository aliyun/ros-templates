...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/backup-recovery/cross-the-available-zone-epidemic-control.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Same Region Cross Availability Zone Disaster Recovery - Cloud Stability Assurance - Epidemic Prevention Project Infrastructure Construction&isSimplified=true&balanceIntercept=true) to enter the deployment page.
