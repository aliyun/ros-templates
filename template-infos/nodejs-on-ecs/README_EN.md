Please translate the following content into English, and keep the original format:
## Automated Deployment
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/help/ecs/nodejs-on-ecs.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Deploy Node.js Environment&isSimplified=true&balanceIntercept=true) to enter the deployment page.
...
4. When the **Resource Stack Information** page shows that the **Status** is **Created Successfully**, the automated deployment is completed.
