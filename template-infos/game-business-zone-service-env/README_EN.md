...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/studio-entertainment/game-business-zone-service-env.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Game Business Zone Consolidation&isSimplified=true&balanceIntercept=true) to enter the deployment page.
