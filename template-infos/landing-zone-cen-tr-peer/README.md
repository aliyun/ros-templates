## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/internet-network/landing-zone-cen-tr-peer.yml&hideStepRow=true&hideStackConfig=true&pageTitle=基于VPC对等连接与转发路由器组合实现多VPC互通&isSimplified=true&balanceIntercept=true)进入部署页面。
