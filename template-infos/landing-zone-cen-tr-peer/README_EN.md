...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/internet-network/landing-zone-cen-tr-peer.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Based on VPC Peer Connection and Forwarding Router Combination to Achieve Interconnection of Multiple VPCs&isSimplified=true&balanceIntercept=true) to enter the deployment page.
