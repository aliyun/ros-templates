## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/data-analysis/low-cost-offline-big-data-analysis-emr.yml&hideStepRow=true&hideStackConfig=true&pageTitle=EMR弹性低成本离线大数据分析&isSimplified=true&balanceIntercept=true)进入部署页面。
