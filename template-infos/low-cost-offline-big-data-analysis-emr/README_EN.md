...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/data-analysis/low-cost-offline-big-data-analysis-emr.yml&hideStepRow=true&hideStackConfig=true&pageTitle=EMR Elastic Low-Cost Offline Big Data Analysis&isSimplified=true&balanceIntercept=true) to enter the deployment page.
