...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/examples/network/security-vpc.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Enterprise-level Network Planning - Build Operation and Maintenance Security Network Area&isSimplified=true&balanceIntercept=true) to enter the deployment page.
