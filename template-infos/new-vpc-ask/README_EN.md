...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/examples/elastic/new-vpc-ask.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Create Serverless Kubernetes Cluster (New VPC)&isSimplified=true&balanceIntercept=true) to enter the deployment page.
