...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/internet-network/enterprise-app-hotel-network.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Enterprise Application (Hotel PMS) Hybrid Cloud Networking&isSimplified=true&balanceIntercept=true) to enter the deployment page.
