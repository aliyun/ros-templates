...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/help/ecs/tf-chat-glm-6b.yml&hideStepRow=true&hideStackConfig=true&pageTitle=使用AMD%20CPU实例部署ChatGLM-6B&isSimplified=true&balanceIntercept=true) to enter the deployment page.
