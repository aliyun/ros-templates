...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/examples/network/cen-open-isolated-networks.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Enterprise-level Network Planning - Building a Shared Service Network Area&isSimplified=true&balanceIntercept=true) to enter the deployment page.
