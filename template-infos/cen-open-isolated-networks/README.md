## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/examples/network/cen-open-isolated-networks.yml&hideStepRow=true&hideStackConfig=true&pageTitle=企业级组网规划 - 搭建共享服务网络区&isSimplified=true&balanceIntercept=true)进入部署页面。
