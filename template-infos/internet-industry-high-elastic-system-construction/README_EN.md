...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/enterprise-on-cloud/internet-industry-high-elastic-system-construction.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Cloud Deployment - Building High Elastic System in Internet Industry&isSimplified=true&balanceIntercept=true) to enter the deployment page.
