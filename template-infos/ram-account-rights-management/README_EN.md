...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/security-rule/ram-account-rights-management.yml&hideStepRow=true&hideStackConfig=true&pageTitle=RAM account permission management&isSimplified=true&balanceIntercept=true) to enter the deployment page.
