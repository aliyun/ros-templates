## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/security-rule/ram-account-rights-management.yml&hideStepRow=true&hideStackConfig=true&pageTitle=RAM账号权限管理&isSimplified=true&balanceIntercept=true)进入部署页面。
