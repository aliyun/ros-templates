## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/backup-recovery/application-business-migration.yml&hideStepRow=true&hideStackConfig=true&pageTitle=同地域跨可用区容灾方案2.0 - 应用业务迁移&isSimplified=true&balanceIntercept=true)进入部署页面。
