...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/backup-recovery/application-business-migration.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Same Region Cross Availability Zone Disaster Recovery Solution 2.0 - Application Business Migration&isSimplified=true&balanceIntercept=true) to enter the deployment page.
