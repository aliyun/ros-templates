...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/help/oss/mobile-application-direct-transmission-service.yml&hideStepRow=true&hideStackConfig=true&pageTitle=quickly build mobile application direct transmission service&isSimplified=true&balanceIntercept=true) to enter the deployment page.
