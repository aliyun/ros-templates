## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/bioscience/bcs-3rd-generation-gene-sequence-data-assembly.yml&hideStepRow=true&hideStackConfig=true&pageTitle=BCS三代基因测序数据组装&isSimplified=true&balanceIntercept=true)进入部署页面。
