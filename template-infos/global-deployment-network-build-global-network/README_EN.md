...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/internet-network/global-deployment-network-build-global-network.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Online Education Global Deployment Network Planning - Build a Global Region Network&isSimplified=true&balanceIntercept=true) to enter the deployment page.
