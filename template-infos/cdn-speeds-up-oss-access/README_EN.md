...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/help/oss/cdn-speeds-up-oss-access.yml&hideStepRow=true&hideStackConfig=true&pageTitle=使用CDN加速OSS访问&isSimplified=true&balanceIntercept=true) to enter the deployment page.
