...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/container-micro-service/spring-cloud-cloud-native-migration.yml&hideStepRow=true&hideStackConfig=true&pageTitle=SpringCloud-Cloud Native Migration&isSimplified=true&balanceIntercept=true) to enter the deployment page.
