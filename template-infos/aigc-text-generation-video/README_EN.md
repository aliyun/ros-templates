...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/help/ecs/aigc-text-generation-video.yml&hideStepRow=true&hideStackConfig=true&pageTitle=AIGC Text Generation Video&isSimplified=true&balanceIntercept=true) to enter the deployment page.
