...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/help/ecs/aigc-text-generation-3d-model.yml&hideStepRow=true&hideStackConfig=true&pageTitle= Text Generation 3D Model &isSimplified=true&balanceIntercept=true) to enter the deployment page.
