...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/middleware/existing-vpc-cluster-kafka.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Kafka cluster version (existing VPC)&isSimplified=true&balanceIntercept=true) to enter the deployment page.
