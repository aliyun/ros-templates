...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/internet-network/landing-zone-cen-tr.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Based on CEN-TR to achieve enterprise-level cloud interconnection&isSimplified=true&balanceIntercept=true) to enter the deployment page.
