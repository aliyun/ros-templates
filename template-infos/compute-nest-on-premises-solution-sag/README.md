## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/compute-nest/compute-nest-on-premises-solution-sag.yml&hideStepRow=true&hideStackConfig=true&pageTitle=计算巢虚拟互联网云下服务上云(SAG版本)&isSimplified=true&balanceIntercept=true)进入部署页面。
