...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/compute-nest/compute-nest-on-premises-solution-sag.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Compute Nest Virtual Internet Cloud Under Service Cloud (SAG Version)&isSimplified=true&balanceIntercept=true) to enter the deployment page.
