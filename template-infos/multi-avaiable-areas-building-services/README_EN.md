...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/internet-network/multi-avaiable-areas-building-services.yml&hideStepRow=true&hideStackConfig=true&pageTitle=组建多可用区多地域的混合云 - 多可用区单地域搭建服务&isSimplified=true&balanceIntercept=true) to enter the deployment page.
