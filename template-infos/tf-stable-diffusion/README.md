## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/help/ecs/tf-stable-diffusion.yml&hideStepRow=true&hideStackConfig=true&pageTitle=使用AMD%20CPU实例部署Stable%20Diffusion&isSimplified=true&balanceIntercept=true)进入部署页面。
