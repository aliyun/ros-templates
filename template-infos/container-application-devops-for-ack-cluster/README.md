## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/devops/container-application-devops-for-ack-cluster.yml&hideStepRow=true&hideStackConfig=true&pageTitle=容器应用DevOps for ACK集群&isSimplified=true&balanceIntercept=true)进入部署页面。
