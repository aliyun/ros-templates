...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/devops/container-application-devops-for-ack-cluster.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Container Application DevOps for ACK Cluster&isSimplified=true&balanceIntercept=true) to enter the deployment page.
