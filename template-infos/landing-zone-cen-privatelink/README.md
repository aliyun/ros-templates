## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/internet-network/landing-zone-cen-privatelink.yml&hideStepRow=true&hideStackConfig=true&pageTitle=企业级私网互联方案&isSimplified=true&balanceIntercept=true)进入部署页面。
