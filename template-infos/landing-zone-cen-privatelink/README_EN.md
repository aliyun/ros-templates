...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/internet-network/landing-zone-cen-privatelink.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Enterprise-level private network interconnection solution&isSimplified=true&balanceIntercept=true) to enter the deployment page.
