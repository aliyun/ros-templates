...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/backup-recovery/deploy-the-rds-environment.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Database异地备份及查询 - 部署云上VPC网络的RDS环境&isSimplified=true&balanceIntercept=true) to enter the deployment page.
