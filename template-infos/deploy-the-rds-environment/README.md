## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/backup-recovery/deploy-the-rds-environment.yml&hideStepRow=true&hideStackConfig=true&pageTitle=数据库异地备份及查询 - 部署云上VPC网络的RDS环境&isSimplified=true&balanceIntercept=true)进入部署页面。
