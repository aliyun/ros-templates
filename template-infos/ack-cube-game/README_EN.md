...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/documents/help/ack/ack-cube-game.yml&hideStepRow=true&hideStackConfig=true&pageTitle=使用ACK部署魔方游戏&isSimplified=true&balanceIntercept=true) to enter the deployment page.
