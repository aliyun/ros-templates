...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/backup-recovery/single-available-zone-building-application.yml&hideStepRow=true&hideStackConfig=true&pageTitle=Same Region Cross Availability Zone Disaster Recovery Solution 2.0 - Single Availability Zone Application Building&isSimplified=true&balanceIntercept=true) to enter the deployment page.
