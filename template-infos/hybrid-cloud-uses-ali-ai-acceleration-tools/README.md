## 自动化部署
1. 点击[部署链接](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/machine-learning-ai/hybrid-cloud-uses-ali-ai-acceleration-tools.yml&hideStepRow=true&hideStackConfig=true&pageTitle=混合云使用飞天AI加速工具&isSimplified=true&balanceIntercept=true)进入部署页面。
