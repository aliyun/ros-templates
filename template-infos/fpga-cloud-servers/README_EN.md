...
1. Click [Deployment Link](https://ros.console.aliyun.com/region/stacks/create?templateUrl=https://ros-public-templates.oss-cn-hangzhou.aliyuncs.com/ros-templates/solutions/media-service/fpga-cloud-servers.yml&hideStepRow=true&hideStackConfig=true&pageTitle=FPGA cloud servers accelerate picture and video transcoding&isSimplified=true&balanceIntercept=true) to enter the deployment page.
